...
class ModelTrainer(object):
    ...
    def evaluateFromList(self, test_list, test_path, nDataLoaderThread, distributed, print_interval=100, num_eval=10, **kwargs):
        ...
        setfiles.sort()
        # new_file = setfiles[:-40]

        ## Define test data loader
        # test_dataset = test_dataset_loader(new_file, test_path, num_eval=num_eval, **kwargs)
        ...
        test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=0, drop_last=True, sampler=sampler)
