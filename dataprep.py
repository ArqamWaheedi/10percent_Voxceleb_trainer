...
if __name__ == "__main__":
    ...
    if args.augment:
        print("Skipping download. Using existing 10% MUSAN and RIRS data.")
        args.save_path = "/kaggle/working/data"  # Keep processed data in the same location
        split_musan(args)  # Process your subset
        print('split_musan done')
