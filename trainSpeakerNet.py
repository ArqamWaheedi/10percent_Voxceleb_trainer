...
parser.add_argument('--train_list', type=str, default="/kaggle/working/data/train_list.txt", help='Train list')
# parser.add_argument('--test_list', type=str, default="data/test_list.txt", help='Evaluation list')
parser.add_argument('--test_list', type=str, default="/kaggle/working/data/VoxCeleb/veri_test2.txt", help='Evaluation list')
# parser.add_argument('--train_path',     type=str,   default="data/voxceleb2", help='Absolute path to the train set')
# parser.add_argument('--test_path',      type=str,   default="data/voxceleb1", help='Absolute path to the test set')
parser.add_argument('--train_path', type=str, default="/kaggle/working/data/VoxCeleb/vox1_dev_wav",
                    help='Absolute path to the train set')
parser.add_argument('--test_path', type=str, default="/kaggle/working/data/VoxCeleb/vox1_test_wav",
                    help='Absolute path to the test set')
# parser.add_argument('--musan_path',     type=str,   default="data/musan_split", help='Absolute path to the test set')
parser.add_argument('--musan_path', type=str, default="/kaggle/working/data/musan_split", help='Absolute path to the test set')
# parser.add_argument('--rir_path',       type=str,   default="data/RIRS_NOISES/simulated_rirs", help='Absolute path to the test set')
parser.add_argument('--rir_path', type=str, default="/kaggle/working/data/RIRS_NOISES/simulated_rirs",
                    help='Absolute path to the test set')
